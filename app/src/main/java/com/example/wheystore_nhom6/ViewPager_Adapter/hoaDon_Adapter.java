...
public class hoaDon_Adapter extends RecyclerView.Adapter<hoaDon_Adapter.ViewHoder> {
    ...
    public void onBindViewHolder(@NonNull ViewHoder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.coin.setText(formatter.format(_hd.getPriceSanPham()*_hd.getCount())+" vnd");
        holder.soLuong.setText("Số lượng : "+_hd.getCount());
...
//                thongKe_Dao.create_thongKe(sanPham_thongKe, context);
                ...
                Picasso.get().load(_hd.getImageSanPham()).resize(350,350).centerCrop().into(img);
                ...
                //
                title.setText(_hd.getNameSanPham());
                values.setText("Số lượng : "+String.valueOf(_hd.getCount()));
                coin.setText(formatter.format(_hd.getPriceSanPham())+" vnd" );
                nameUser.setText("Name : "+_hd.getName());
