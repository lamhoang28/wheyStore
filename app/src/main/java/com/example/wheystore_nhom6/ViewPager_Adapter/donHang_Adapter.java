...
public class donHang_Adapter extends RecyclerView.Adapter<donHang_Adapter.ViewHoder> {
    ...
    public void onBindViewHolder(@NonNull ViewHoder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.nameUser.setText(_hd.getName());
        holder.adressUser.setText(_hd.getAdress());
        holder.phoneUser.setText(_hd.getPhone());
        holder.title.setText(_hd.getNameSanPham());
        holder.coin.setText(_hd.getPriceSanPham());
        holder.count.setText(String.valueOf("Số lượng : "+_hd.getCount()));

        DecimalFormat formatter = new DecimalFormat("###,###,###");

        Log.e("TAG", "onBindViewHolder: "+formatter.format(_hd.getPriceSanPham()) );
...
//            Log.e("TAG", "an xoa: " );
//        }
        int Sum = _hd.getCount()*_hd.getPriceSanPham();

        Picasso.get().load(_hd.getImageSanPham()).resize(350,350).centerCrop().into(holder.img);
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                title.setText("Delete "+_hd.getNameSanPham()+" ?");
        ...
        holder.send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sanPham_dao.checkCount(_hd.getIdPost(),_hd.getCount(),yes);
                yes.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        _hd = _list.get(position);
                       ...
                       // thongKe = new sanPham_thongKe("id_autorender",_hd.getImageSanPham(),_hd.getTitle(),String.valueOf(_hd.getValue()),_hd.getCoin(),_hd.getDate());
                        thongKe_dao.create_thongKe(thongKe, v.getContext());
                        //update số lượng sản phẩm
                        sanPham_dao.update_sanPham_nhap(_hd.getIdPost(), _hd.getCount(), "count");
                        sanPham_dao.update_sanPham_xuat(_hd.getIdPost(), _hd.getCount(), "xuat");
                        dialog.dismiss();
                    }
                });
                no.setOnClickListener(new View.OnClickListener() {
