...
public class Bottom_sheet_fragment extends BottomSheetDialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        giam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                coinSum.setText(formatter.format(_sp.getPrice()*value) +" vnd");
                if (value==0||value<0){
                    giam.setEnabled(false);
    ...
    private void setData(){
        ...
        Picasso.get().load(_sp.getImage()).centerCrop().resize(100,100).into(img);
        title.setText(_sp.getName());
        coin.setText(formatter.format(_sp.getPrice())  +" vnd");
        coinSum.setText(formatter.format(_sp.getPrice()) +" vnd");
