        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (check==5){
                    ...
                    //_model = new Model(userName.getEditText().getText().toString(),pass.getEditText().getText().toString(),pass.getEditText().getText().toString(),email.getEditText().getText().toString(),phone.getEditText().getText().toString(),adress.getEditText().getText().toString());
                    user_dao.Edit_User(_model,email.getEditText().getText().toString(),Acti_updateProfile.this);
                    check=0;
                }else{
